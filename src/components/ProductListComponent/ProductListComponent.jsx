...
const renderPaginationItems = () => {
  ...
  useEffect(() => {
      ...
      const fetchPlants = async () => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/plant");
      ...
      const fetchPots = async () => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/pot");
          const jsonData = await response.json();
      ...
      const fetchProducts = async () => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/pot/all");
          const jsonData = await response.json();
      ...
      const fetchOneTypePlants = async (maloai) => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/plant/search?ml="+maloai);
          const jsonData = await response.json();
          setProducts(jsonData["plants"]);
        } catch (error) {
          console.error("Error fetching data:", error);
      ...
      const fetchOneTypePots = async (maloai) => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/pot/search?ml="+maloai);
          const jsonData = await response.json();
          setProducts(jsonData["pots"]);
        } catch (error) {
          console.error("Error fetching data:", error);
      ...
      const fetchTypePlants = async () => {
        try {
          const response = await fetch("https://backend-caycanh.onrender.com/api/v1/producttype/plant");
          const jsonData = await response.json();
