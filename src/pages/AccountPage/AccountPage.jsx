...
const AccountPage = ({type}) => {
    const log = async () => {
        ...
        try {
            const response = await fetch("https://backend-caycanh.onrender.com/api/v1/account/user/login", {
                method: 'POST',
                headers: {
    ...
    const register = async () => {
        ...
        if (captchaElement.value.toLowerCase() === recaptchaElement.value.toLowerCase()) {
            try {
                const response = await fetch("https://backend-caycanh.onrender.com/api/v1/account/user/register", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const takepass = async () => {
        ...
        try {
            const response = await fetch("https://backend-caycanh.onrender.com/api/v1/account/resetPassword", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
