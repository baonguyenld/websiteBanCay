    ...
    useEffect(()=>{
        const fetchTypePlants = async () => {
            ...
            const fetchProducts = async () => {
                ...
                if (flag==true) {
                    try {
                        const response = await fetch("https://backend-caycanh.onrender.com/api/v1/plant/search/AN31583688");
                        const jsonData = await response.json();
                    ...
                    try {
                        const response = await fetch("https://backend-caycanh.onrender.com/api/v1/pot/search/"+masp);
                        const jsonData = await response.json();
