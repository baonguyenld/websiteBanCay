...
function OrderPageAdmin() {
  ...
  const handleAddOrder = () => {
    axios
      .post("https://backend-caycanh.onrender.com/api/v1/order/createOrder", newOrder)
      .then(() => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch("https://backend-caycanh.onrender.com/api/v1/order");
  ...
  const handleDeleteOrder = (orderId) => {
    axios
      .delete(`https://backend-caycanh.onrender.com/api/v1/order/deleteOrder/${orderId}`)
      .then(() => {
