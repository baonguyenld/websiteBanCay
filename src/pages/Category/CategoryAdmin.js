...
const CategoryAdmin = () => {
  ...
  const handleAddProducttype = () => {
    axios
      .post("https://backend-caycanh.onrender.com/api/v1/order/addCategory", newCategories)
      .then(() => {
  ...
  const handleDeleteOrder = (_id) => {
    axios
      .delete(`https://backend-caycanh.onrender.com/api/v1/order/deleteProductType/${_id}`)
      .then(() => {
  ...
  const handleUpdateOrder = (orderId, order) => {
    axios
      .put(
        `https://backend-caycanh.onrender.com/api/v1/order/updateOrder/${orderId}`,
        updatedOrder
      )
      .then(() => {
